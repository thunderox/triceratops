...
class triceratopsUI : public UI
{
	public:
		...
		triceratopsUI() : UI(980, 460)
		{
			...
			Delirium_UI_Widget_Set_Value(GUI, widget_osc1_volume, 0.8);
			Delirium_UI_Widget_Set_Default_Value(GUI, widget_osc1_volume, 0.8);
			...
			Delirium_UI_Widget_Set_Value(GUI, widget_osc2_active, 0);
			...
			Delirium_UI_Widget_Set_Value(GUI, widget_osc2_volume, 0.8);
			Delirium_UI_Widget_Set_Default_Value(GUI, widget_osc2_volume, 0.8);
			...
			Delirium_UI_Widget_Set_Value(GUI, widget_osc3_volume, 0.8);
			Delirium_UI_Widget_Set_Default_Value(GUI, widget_osc3_volume, 0.8);
			...
			Delirium_UI_Widget_Set_Value(GUI, widget_osc3_octave, 2);
			...
			Delirium_UI_Widget_Set_Min_Max(GUI, widget_unison_activate, 0,1);
			Delirium_UI_Widget_Set_Value(GUI, widget_unison_activate, 0);
			...
			int widget_env2_route1 = Delirium_UI_Create_Widget(GUI, deliriumUI_Fader_Route, 0, panelX + 6, panelY + 1.25, 1, 5.25, "FILTER", TRICERATOPS_ADSR2_ROUTE_ONE);
			Delirium_UI_Widget_Set_Min_Max(GUI, widget_env2_route1, 1,0);
			Delirium_UI_Widget_Set_Value(GUI, widget_env2_route1, 0);
			Delirium_UI_Widget_Set_Route_Destination(GUI, widget_env2_route1, 1);
			...
			fParameters_widget_number[TRICERATOPS_ADSR2_ROUTE_ONE_DEST] = widget_env2_route1; 
			...
			Delirium_UI_Widget_Set_Min_Max(GUI, widget_filter_type, 0,5);
			Delirium_UI_Widget_Set_Value(GUI, widget_filter_type, 1);
			...
			int widget_amp_drive = Delirium_UI_Create_Widget(GUI, deliriumUI_Fader, 0, panelX + 15, panelY + 1.25, 1, 5.25, "DRIVE",TRICERATOPS_AMP_DRIVE);
